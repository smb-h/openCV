...
from video_conf import CFEVideoConf
...
# face_cascade        = cv2.CascadeClassifier(cv2.data.haarcascades + "cascades/data/haarcascade_frontalface_default.xml")
eyes_cascade        = cv2.CascadeClassifier('cascades/3rd-party/frontalEyes35x16.xml')
# eyes_cascade        = cv2.CascadeClassifier(cv2.data.haarcascades + 'cascades/3rd-party/frontalEyes35x16.xml')
nose_cascade        = cv2.CascadeClassifier('cascades/3rd-party/Nose18x15.xml')
# nose_cascade        = cv2.CascadeClassifier(cv2.data.haarcascades + 'cascades/3rd-party/Nose18x15.xml')
